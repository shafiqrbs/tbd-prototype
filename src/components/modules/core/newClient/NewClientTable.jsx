...
import NewClientViewModel from "./NewClientViewModel.jsx";
...
function NewClientTable() {
    ...
    return (
        <>
                                        ...
                                        render: (data) => (
                                            <Group gap={4} justify="right" wrap="nowrap">
                                                <ActionIcon
                                                    ...
                                                    color="green"
                                                    onClick={() => {
                                                        setNewClientViewModel(true)
                                                        dispatch(showEntityData('core/newClient/' + data.id))
                                                    }}
                                                >
                                                    <IconEye size={16} />
                                                </ActionIcon>
                                                <ActionIcon
                                                    ...
                                                    onClick={() => {
                                                        ...
                                                        dispatch(editEntityData('core/newClient/' + data.id))
                                                ...
                                                <ActionIcon
                                                    ...
                                                    onClick={() => {
                                                        modals.openConfirmModal({
                                                            ...
                                                            onConfirm: () => {
                                                                dispatch(deleteEntityData('core/newClient/' + data.id))
            ...
            {
                newClientViewModel &&
                <NewClientViewModel newClientViewModel={newClientViewModel} setNewClientViewModel={setNewClientViewModel} />
            }
        </>
    );
}
