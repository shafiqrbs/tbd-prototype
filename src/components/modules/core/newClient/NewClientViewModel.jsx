...
function NewClientViewModel(props) {
    ...
    return (
        <Modal opened={props.NewClientViewModel} onClose={closeModel} title={t('CustomerDetailsData')} size="75%" overlayProps={{
...
export default NewClientViewModel;
