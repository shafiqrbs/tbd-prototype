...
import BankAccountViewModel from "./BankAccountViewModel.jsx";
    ...
    return (
        <>
                                        ...
                                        render: (data) => (
                                            <Group gap={4} justify="right" wrap="nowrap">
                                                <ActionIcon
                                                    ...
                                                    color="green"
                                                    onClick={() => {
                                                        setBankAccountViewModel(true)
                                                        dispatch(showEntityData('core/bankAccount/' + data.id))
                                                    }}
                                                >
                                                    <IconEye size={16} />
                                                </ActionIcon>
                                                <ActionIcon
                                                    ...
                                                    onClick={() => {
                                                        ...
                                                        dispatch(editEntityData('core/bankAccount/' + data.id))
                                                ...
                                                <ActionIcon
                                                    ...
                                                    onClick={() => {
                                                        modals.openConfirmModal({
                                                            ...
                                                            onConfirm: () => {
                                                                dispatch(deleteEntityData('core/bankAccount/' + data.id))
            ...
            </Box>
            {
                ...
                <BankAccountViewModel bankAccountViewModel={bankAccountViewModel} setBankAccountViewModel={setBankAccountViewModel} />
            }
        </>
    );
}
