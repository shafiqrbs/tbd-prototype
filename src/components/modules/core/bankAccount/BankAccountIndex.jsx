...
import BankAccountTable from "./BankAccountTable.jsx";
import BankAccountUpdateForm from "./BankAccountUpdateForm.jsx";
import {
            ...
            {progress === 100 &&
                <Box>
                    <Box pl={`md`} pr={8} pb={'8'} pt={'6'} bg={'gray.1'}>
                        <Grid>
                            <Grid.Col span={12}>
                                <Title order={6} pl={'md'} fz={'18'} c={'indigo.4'}>{t('BankAccountInformation')}</Title>
                            </Grid.Col>
                        </Grid>
                    </Box>
                    <Box pr={12} pl={'12'}>
                        <Grid>
                            ...
                            <Grid.Col span={4}>
                                {
                                    insertType === 'create' ? <BankAccountForm /> : <BankAccountUpdateForm />
                                }
                            </Grid.Col>
                        </Grid>
                    </Box>
