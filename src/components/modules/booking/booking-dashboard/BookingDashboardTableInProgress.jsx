...
import BookingDashboardSearch from "./BookingDashboardSearch.jsx";

function BookingDashboardTableInProgress() {
      ...
      <Box className={" borderRadiusAllVoucherNew"} bg={"white"}>
        <Box bg="white" className="borderRadiusAll" m={"xs"}>
          <Box
            ...
            pt={"xs"}
            bg={"white"}>
            <BookingDashboardSearch module={"customer"} />
          </Box>
        </Box>
...
export default BookingDashboardTableInProgress;
