...
import BookingDashboardFormIndex from "./BookingDashboardFormIndex.jsx";
import BookingDashboardTableNew from "./BookingDashboardTableNew.jsx";
import BookingDashboardTableInProgress from "./BookingDashboardTableInProgress.jsx";
import BookingDashboardTableApprove from "./BookingDashboardTableApprove.jsx";
import BookingDashboardTableArchive from "./BookingDashboardTableArchive.jsx";
import { Tooltip } from "recharts";
import styles from "../../../../assets/css/BookingIndex.module.css";
import { IconX } from "@tabler/icons-react";
function BookingDashboardIndex() {
              ...
              <Box className="" bg={"#f0f1f9"}>
                <Tabs
                  ...
                  <Tabs.Panel value="New">
                    <Box>
                      <BookingDashboardTableNew />
                    </Box>
                  </Tabs.Panel>
                  <Tabs.Panel value="InProgress">
                    <Box>
                      <BookingDashboardTableInProgress />
                    </Box>
                  </Tabs.Panel>
                  <Tabs.Panel value="Approve">
                    <Box>
                      <BookingDashboardTableApprove />
                    </Box>
                  </Tabs.Panel>
                  <Tabs.Panel value="Archive">
                    <Box>
                      <BookingDashboardTableArchive />
                    </Box>
                  </Tabs.Panel>
                  <Tabs.Panel value="BookingEntry">
                    <Box bg={"white"}>
                      <BookingDashboardFormIndex />
                    </Box>
                  </Tabs.Panel>
                </Tabs>
              </Box>
...
export default BookingDashboardIndex;
