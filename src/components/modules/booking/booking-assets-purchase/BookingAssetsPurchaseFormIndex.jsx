...
import BookingAssetsPurchaseFormSection from "./BookingAssetsPurchaseFormSection.jsx";
import SwitchForm from "../../../form-builders/SwitchForm.jsx";
import { DateInput } from "@mantine/dates";
import InputNumberForm from "../../../form-builders/InputNumberForm.jsx";
import TextAreaForm from "../../../form-builders/TextAreaForm.jsx";

function BookingAssetsPurchaseFormIndex(props) {
        ...
        <Box>
          <Grid columns={24} gutter={{ base: 6 }}>
            ...
            <Grid.Col span={8}>
              <Box>
                <Box bg={"white"}>
                  <BookingAssetsPurchaseFormSection />
                </Box>
              </Box>
            </Grid.Col>
...
export default BookingAssetsPurchaseFormIndex;
