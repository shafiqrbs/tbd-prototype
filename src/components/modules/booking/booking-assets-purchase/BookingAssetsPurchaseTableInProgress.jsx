...
import BookingAssetsPurchaseSearch from "./BookingAssetsPurchaseSearch.jsx";

function BookingAssetsPurchaseTableInProgress() {
      ...
      <Box className={" borderRadiusAllVoucherNew"} bg={"white"}>
        <Box bg="white" className="borderRadiusAll" m={"xs"}>
          <Box
            ...
            pt={"xs"}
            bg={"white"}>
            <BookingAssetsPurchaseSearch module={"customer"} />
          </Box>
        </Box>
...
export default BookingAssetsPurchaseTableInProgress;
