...
import BookingHumanResourceSearch from "./BookingHumanResourceSearch.jsx";

function BookingHumanResourceTableInProgress() {
      ...
      <Box className={" borderRadiusAllVoucherNew"} bg={"white"}>
        <Box bg="white" className="borderRadiusAll" m={"xs"}>
          <Box
            ...
            pt={"xs"}
            bg={"white"}>
            <BookingHumanResourceSearch module={"customer"} />
          </Box>
        </Box>
...
export default BookingHumanResourceTableInProgress;
