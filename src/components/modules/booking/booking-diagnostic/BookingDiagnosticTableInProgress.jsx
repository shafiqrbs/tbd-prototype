...
import BookingDiagnosticSearch from "./BookingDiagnosticSearch.jsx";

function BookingDiagnosticTableInProgress() {
      ...
      <Box className={" borderRadiusAllVoucherNew"} bg={"white"}>
        <Box bg="white" className="borderRadiusAll" m={"xs"}>
          <Box
            ...
            pt={"xs"}
            bg={"white"}>
            <BookingDiagnosticSearch module={"customer"} />
          </Box>
        </Box>
...
export default BookingDiagnosticTableInProgress;
