              ...
              <Box
                ...
                <Tabs
                  ...
                  <Tabs.Panel value="All">
                    {/* data table start */}
                    <Box id="ipd_table" className="borderRadiusAll">
                      <DataTable
                        classNames={{
                          root: tableCss.root,
