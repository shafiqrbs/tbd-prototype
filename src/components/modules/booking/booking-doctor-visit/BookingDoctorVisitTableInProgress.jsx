...
import BookingDoctorVisitSearch from "./BookingDoctorVisitSearch.jsx";

function BookingDoctorVisitTableInProgress() {
      ...
      <Box className={" borderRadiusAllVoucherNew"} bg={"white"}>
        <Box bg="white" className="borderRadiusAll" m={"xs"}>
          <Box
            ...
            pt={"xs"}
            bg={"white"}>
            <BookingDoctorVisitSearch module={"customer"} />
          </Box>
        </Box>
...
export default BookingDoctorVisitTableInProgress;
