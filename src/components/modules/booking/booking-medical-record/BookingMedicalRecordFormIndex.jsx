...
import BookingMedicalRecordFormSection from "./BookingMedicalRecordFormSection.jsx";
import SwitchForm from "../../../form-builders/SwitchForm.jsx";
import { DateInput } from "@mantine/dates";
import InputNumberForm from "../../../form-builders/InputNumberForm.jsx";
import TextAreaForm from "../../../form-builders/TextAreaForm.jsx";

function BookingMedicalRecordFormIndex(props) {
        ...
        <Box>
          <Grid columns={24} gutter={{ base: 6 }}>
            ...
            <Grid.Col span={6.5}>
              <Box>
                <Box bg={"white"}>
                  <BookingMedicalRecordFormSection />
                </Box>
              </Box>
            </Grid.Col>
            <Grid.Col span={14}>
...
export default BookingMedicalRecordFormIndex;
