...
import BookingMedicalRecordSearch from "./BookingMedicalRecordSearch.jsx";

function BookingMedicalRecordTableInProgress() {
      ...
      <Box className={" borderRadiusAllVoucherNew"} bg={"white"}>
        <Box bg="white" className="borderRadiusAll" m={"xs"}>
          <Box
            ...
            pt={"xs"}
            bg={"white"}>
            <BookingMedicalRecordSearch module={"customer"} />
          </Box>
        </Box>
...
export default BookingMedicalRecordTableInProgress;
