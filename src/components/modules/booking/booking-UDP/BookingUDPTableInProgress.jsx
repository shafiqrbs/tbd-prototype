...
import BookingUDPSearch from "./BookingUDPSearch.jsx";

function BookingUDPTableInProgress() {
      ...
      <Box className={" borderRadiusAllVoucherNew"} bg={"white"}>
        <Box bg="white" className="borderRadiusAll" m={"xs"}>
          <Box
            ...
            pt={"xs"}
            bg={"white"}>
            <BookingUDPSearch module={"customer"} />
          </Box>
        </Box>
...
export default BookingUDPTableInProgress;
