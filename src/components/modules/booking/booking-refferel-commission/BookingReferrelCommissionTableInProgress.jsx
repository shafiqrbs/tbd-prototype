...
import BookingReferrelCommissionSearch from "./BookingReferrelCommissionSearch.jsx";

function BookingReferrelCommissionTableInProgress() {
      ...
      <Box className={" borderRadiusAllVoucherNew"} bg={"white"}>
        <Box bg="white" className="borderRadiusAll" m={"xs"}>
          <Box
            ...
            pt={"xs"}
            bg={"white"}>
            <BookingReferrelCommissionSearch module={"customer"} />
          </Box>
        </Box>
          ...
          <Box className="borderRadiusAll">
            <DataTable
              ...
              columns={[
                ...
                { accessor: "ref_Booking", title: t("RefBooking") },
                { accessor: "Booking_type", title: t("BookingType") },
...
export default BookingReferrelCommissionTableInProgress;
