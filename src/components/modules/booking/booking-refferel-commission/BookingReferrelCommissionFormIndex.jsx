...
import BookingReferrelCommissionFormSection from "./BookingReferrelCommissionFormSection.jsx";
import SwitchForm from "../../../form-builders/SwitchForm.jsx";
import { DateInput } from "@mantine/dates";
import InputNumberForm from "../../../form-builders/InputNumberForm.jsx";
import TextAreaForm from "../../../form-builders/TextAreaForm.jsx";

function BookingReferrelCommissionFormIndex(props) {
        ...
        <Box>
          <Grid columns={24} gutter={{ base: 6 }}>
            ...
            <Grid.Col span={8}>
              <Box>
                <Box bg={"white"}>
                  <BookingReferrelCommissionFormSection />
                </Box>
              </Box>
            </Grid.Col>
...
export default BookingReferrelCommissionFormIndex;
