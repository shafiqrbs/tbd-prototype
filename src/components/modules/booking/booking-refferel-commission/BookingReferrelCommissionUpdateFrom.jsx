...
function BookingReferrelCommissionUpdateFrom(props) {
  ...
  useEffect(() => {
    form.setValues({
      ...
      authorised_mode_id: entityEditData.authorised_mode_id
        ? entityEditData.authorised_mode_id
        : "",
      account_mode_id: entityEditData.account_mode_id
        ? entityEditData.account_mode_id
        : "",
      service_charge: entityEditData.service_charge
        ? entityEditData.service_charge
        : "",
      account_owner: entityEditData.account_owner
        ? entityEditData.account_owner
        : "",
...
export default BookingReferrelCommissionUpdateFrom;
