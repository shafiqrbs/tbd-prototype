...
function BookingReferrelCommissionSearch(props) {
        ...
        <Grid.Col span={2}>
          <Tooltip
            ...
            <DateInput
              ...
              onChange={(e) => {
                dispatch(
                  setSalesFilterData({ ...salesFilterData, ["start_date"]: e })
                );
                e !== ""
        ...
        <Grid.Col span={2}>
          <Tooltip
            ...
            <DateInput
              ...
              onChange={(e) => {
                dispatch(
                  setSalesFilterData({ ...salesFilterData, ["end_date"]: e })
                );
                e !== ""
...
export default BookingReferrelCommissionSearch;
