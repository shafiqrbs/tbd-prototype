...
import BookingReportsSearch from "./BookingReportsSearch.jsx";

function BookingReportsTableInProgress() {
      ...
      <Box className={" borderRadiusAllVoucherNew"} bg={"white"}>
        <Box bg="white" className="borderRadiusAll" m={"xs"}>
          <Box
            ...
            pt={"xs"}
            bg={"white"}>
            <BookingReportsSearch module={"customer"} />
          </Box>
        </Box>
...
export default BookingReportsTableInProgress;
