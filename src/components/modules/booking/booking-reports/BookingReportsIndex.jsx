...
import BookingReportsFormIndex from "./BookingReportsFormIndex.jsx";
import BookingReportsTableNew from "./BookingReportsTableNew.jsx";
import BookingReportsTableInProgress from "./BookingReportsTableInProgress.jsx";
import BookingReportsTableApprove from "./BookingReportsTableApprove.jsx";
import BookingReportsTableArchive from "./BookingReportsTableArchive.jsx";
import { Tooltip } from "recharts";
import styles from "../../../../assets/css/BookingIndex.module.css";
import { IconX } from "@tabler/icons-react";
function BookingReportsIndex() {
              ...
              <Box className="" bg={"#f0f1f9"}>
                <Tabs
                  ...
                  <Tabs.Panel value="New">
                    <Box>
                      <BookingReportsTableNew />
                    </Box>
                  </Tabs.Panel>
                  <Tabs.Panel value="InProgress">
                    <Box>
                      <BookingReportsTableInProgress />
                    </Box>
                  </Tabs.Panel>
                  <Tabs.Panel value="Approve">
                    <Box>
                      <BookingReportsTableApprove />
                    </Box>
                  </Tabs.Panel>
                  <Tabs.Panel value="Archive">
                    <Box>
                      <BookingReportsTableArchive />
                    </Box>
                  </Tabs.Panel>
                  <Tabs.Panel value="BookingEntry">
                    <Box bg={"white"}>
                      <BookingReportsFormIndex />
                    </Box>
                  </Tabs.Panel>
                </Tabs>
              </Box>
...
export default BookingReportsIndex;
