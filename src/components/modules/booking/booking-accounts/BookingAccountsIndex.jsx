...
import BookingAccountsFormIndex from "./BookingAccountsFormIndex.jsx";
import BookingAccountsTableNew from "./BookingAccountsTableNew.jsx";
import BookingAccountsTableInProgress from "./BookingAccountsTableInProgress.jsx";
import BookingAccountsTableApprove from "./BookingAccountsTableApprove.jsx";
import BookingAccountsTableArchive from "./BookingAccountsTableArchive.jsx";
import { Tooltip } from "recharts";
import styles from "../../../../assets/css/BookingIndex.module.css";
import { IconX } from "@tabler/icons-react";
function BookingAccountsIndex() {
              ...
              <Box className="" bg={"#f0f1f9"}>
                <Tabs
                  ...
                  <Tabs.Panel value="New">
                    <Box>
                      <BookingAccountsTableNew />
                    </Box>
                  </Tabs.Panel>
                  <Tabs.Panel value="InProgress">
                    <Box>
                      <BookingAccountsTableInProgress />
                    </Box>
                  </Tabs.Panel>
                  <Tabs.Panel value="Approve">
                    <Box>
                      <BookingAccountsTableApprove />
                    </Box>
                  </Tabs.Panel>
                  <Tabs.Panel value="Archive">
                    <Box>
                      <BookingAccountsTableArchive />
                    </Box>
                  </Tabs.Panel>
                  <Tabs.Panel value="BookingEntry">
                    <Box bg={"white"}>
                      <BookingAccountsFormIndex />
                    </Box>
                  </Tabs.Panel>
                </Tabs>
              </Box>
...
export default BookingAccountsIndex;
