...
import BookingAccountsSearch from "./BookingAccountsSearch.jsx";

function BookingAccountsTableInProgress() {
      ...
      <Box className={" borderRadiusAllVoucherNew"} bg={"white"}>
        <Box bg="white" className="borderRadiusAll" m={"xs"}>
          <Box
            ...
            pt={"xs"}
            bg={"white"}>
            <BookingAccountsSearch module={"customer"} />
          </Box>
        </Box>
...
export default BookingAccountsTableInProgress;
