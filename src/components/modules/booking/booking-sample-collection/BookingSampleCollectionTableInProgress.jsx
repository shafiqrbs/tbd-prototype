...
import BookingSampleCollectionSearch from "./BookingSampleCollectionSearch.jsx";

function BookingSampleCollectionTableInProgress() {
      ...
      <Box className={" borderRadiusAllVoucherNew"} bg={"white"}>
        <Box bg="white" className="borderRadiusAll" m={"xs"}>
          <Box
            ...
            pt={"xs"}
            bg={"white"}>
            <BookingSampleCollectionSearch module={"customer"} />
          </Box>
        </Box>
...
export default BookingSampleCollectionTableInProgress;
