...
import BookingSampleCollectionFormSection from "./BookingSampleCollectionFormSection.jsx";
import SwitchForm from "../../../form-builders/SwitchForm.jsx";
import { DateInput } from "@mantine/dates";
import InputNumberForm from "../../../form-builders/InputNumberForm.jsx";
import TextAreaForm from "../../../form-builders/TextAreaForm.jsx";

function BookingSampleCollectionFormIndex(props) {
        ...
        <Box>
          <Grid columns={24} gutter={{ base: 6 }}>
            ...
            <Grid.Col span={8}>
              <Box>
                <Box bg={"white"}>
                  <BookingSampleCollectionFormSection />
                </Box>
              </Box>
            </Grid.Col>
...
export default BookingSampleCollectionFormIndex;
