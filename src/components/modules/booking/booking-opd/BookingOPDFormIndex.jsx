              ...
              <Box
                ...
                <Tabs
                  ...
                  <Tabs.Panel value="All">
                    {/* data table start */}
                    <Box id="opd_table" className="borderRadiusAll">
                      <DataTable
                        classNames={{
                          root: tableCss.root,
...
export default BookingOPDFormIndex;
