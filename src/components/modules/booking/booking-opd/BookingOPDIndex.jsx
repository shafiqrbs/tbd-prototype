...
import BookingOPDFormIndex from "./BookingOPDFormIndex.jsx";
import BookingOPDTableNew from "./BookingOPDTableNew.jsx";
import BookingOPDTableInProgress from "./BookingOPDTableInProgress.jsx";
import BookingOPDTableApprove from "./BookingOPDTableApprove.jsx";
import BookingOPDTableArchive from "./BookingOPDTableArchive.jsx";
import { Tooltip } from "recharts";
import styles from "../../../../assets/css/BookingIndex.module.css";
import { IconX } from "@tabler/icons-react";
function BookingOPDIndex() {
              ...
              <Box className="" bg={"#f0f1f9"}>
                <Tabs
                  ...
                  <Tabs.Panel value="InProgress">
                    <Box>
                      <BookingOPDTableInProgress />
                    </Box>
                  </Tabs.Panel>
                  <Tabs.Panel value="Approve">
                    <Box>
                      <BookingOPDTableApprove />
                    </Box>
                  </Tabs.Panel>
                  <Tabs.Panel value="Archive">
                    <Box>
                      <BookingOPDTableArchive />
                    </Box>
                  </Tabs.Panel>
...
export default BookingOPDIndex;
