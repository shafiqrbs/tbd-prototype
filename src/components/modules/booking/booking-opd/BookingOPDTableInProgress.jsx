...
import BookingOPDSearch from "./BookingOPDSearch.jsx";

function BookingOPDTableInProgress() {
      ...
      <Box className={" borderRadiusAllVoucherNew"} bg={"white"}>
        <Box bg="white" className="borderRadiusAll" m={"xs"}>
          <Box
            ...
            pt={"xs"}
            bg={"white"}>
            <BookingOPDSearch module={"customer"} />
          </Box>
        </Box>
...
export default BookingOPDTableInProgress;
