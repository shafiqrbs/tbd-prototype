...
import BookingOTDetailSection from "./BookingOTDetailSection.jsx";
import BookingOTFormSection from "./BookingOTFormSection.jsx";
import SwitchForm from "../../../form-builders/SwitchForm.jsx";
import { DateInput } from "@mantine/dates";
import InputNumberForm from "../../../form-builders/InputNumberForm.jsx";
import TextAreaForm from "../../../form-builders/TextAreaForm.jsx";

function BookingOTFormIndex(props) {
      ...
      <form
        ...
        <Box>
          <Grid columns={24} gutter={{ base: 6 }}>
            <Grid.Col span={2.5}>
              <Box bg={"white"}>
                <BookingOTDetailSection />
              </Box>
            </Grid.Col>
            <Grid.Col span={6.5}>
              <Box>
                <Box bg={"white"}>
                  <BookingOTFormSection />
                </Box>
              </Box>
            </Grid.Col>
            <Grid.Col span={14}>
...
export default BookingOTFormIndex;
