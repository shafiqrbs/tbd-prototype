...
import BookingPharmacySearch from "./BookingPharmacySearch.jsx";

function BookingPharmacyTableInProgress() {
      ...
      <Box className={" borderRadiusAllVoucherNew"} bg={"white"}>
        <Box bg="white" className="borderRadiusAll" m={"xs"}>
          <Box
            ...
            pt={"xs"}
            bg={"white"}>
            <BookingPharmacySearch module={"customer"} />
          </Box>
        </Box>
...
export default BookingPharmacyTableInProgress;
