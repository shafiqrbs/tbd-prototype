...
import BookingPharmacyFormIndex from "./BookingPharmacyFormIndex.jsx";
import BookingPharmacyTableNew from "./BookingPharmacyTableNew.jsx";
import BookingPharmacyTableInProgress from "./BookingPharmacyTableInProgress.jsx";
import BookingPharmacyTableApprove from "./BookingPharmacyTableApprove.jsx";
import BookingPharmacyTableArchive from "./BookingPharmacyTableArchive.jsx";
import { Tooltip } from "recharts";
import styles from "../../../../assets/css/BookingIndex.module.css";
import { IconX } from "@tabler/icons-react";
function BookingPharmacyIndex() {
              ...
              <Box className="" bg={"#f0f1f9"}>
                <Tabs
                  ...
                  <Tabs.Panel value="New">
                    <Box>
                      <BookingPharmacyTableNew />
                    </Box>
                  </Tabs.Panel>
                  <Tabs.Panel value="InProgress">
                    <Box>
                      <BookingPharmacyTableInProgress />
                    </Box>
                  </Tabs.Panel>
                  <Tabs.Panel value="Approve">
                    <Box>
                      <BookingPharmacyTableApprove />
                    </Box>
                  </Tabs.Panel>
                  <Tabs.Panel value="Archive">
                    <Box>
                      <BookingPharmacyTableArchive />
                    </Box>
                  </Tabs.Panel>
                  <Tabs.Panel value="BookingEntry">
                    <Box bg={"white"}>
                      <BookingPharmacyFormIndex />
                    </Box>
                  </Tabs.Panel>
                </Tabs>
              </Box>
...
export default BookingPharmacyIndex;
