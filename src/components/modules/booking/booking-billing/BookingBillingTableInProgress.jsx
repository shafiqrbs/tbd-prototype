...
import BookingBillingSearch from "./BookingBillingSearch.jsx";

function BookingBillingTableInProgress() {
      ...
      <Box className={" borderRadiusAllVoucherNew"} bg={"white"}>
        <Box bg="white" className="borderRadiusAll" m={"xs"}>
          <Box
            ...
            pt={"xs"}
            bg={"white"}>
            <BookingBillingSearch module={"customer"} />
          </Box>
        </Box>
...
export default BookingBillingTableInProgress;
