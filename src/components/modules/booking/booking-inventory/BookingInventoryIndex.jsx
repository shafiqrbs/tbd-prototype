...
import BookingInventoryFormIndex from "./BookingInventoryFormIndex.jsx";
import BookingInventoryTableNew from "./BookingInventoryTableNew.jsx";
import BookingInventoryTableInProgress from "./BookingInventoryTableInProgress.jsx";
import BookingInventoryTableApprove from "./BookingInventoryTableApprove.jsx";
import BookingInventoryTableArchive from "./BookingInventoryTableArchive.jsx";
import { Tooltip } from "recharts";
import styles from "../../../../assets/css/BookingIndex.module.css";
import { IconX } from "@tabler/icons-react";
function BookingInventoryIndex() {
              ...
              <Box className="" bg={"#f0f1f9"}>
                <Tabs
                  ...
                  <Tabs.Panel value="New">
                    <Box>
                      <BookingInventoryTableNew />
                    </Box>
                  </Tabs.Panel>
                  <Tabs.Panel value="InProgress">
                    <Box>
                      <BookingInventoryTableInProgress />
                    </Box>
                  </Tabs.Panel>
                  <Tabs.Panel value="Approve">
                    <Box>
                      <BookingInventoryTableApprove />
                    </Box>
                  </Tabs.Panel>
                  <Tabs.Panel value="Archive">
                    <Box>
                      <BookingInventoryTableArchive />
                    </Box>
                  </Tabs.Panel>
                  <Tabs.Panel value="BookingEntry">
                    <Box bg={"white"}>
                      <BookingInventoryFormIndex />
                    </Box>
                  </Tabs.Panel>
                </Tabs>
              </Box>
...
export default BookingInventoryIndex;
