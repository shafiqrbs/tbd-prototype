...
import BookingInventorySearch from "./BookingInventorySearch.jsx";

function BookingInventoryTableInProgress() {
      ...
      <Box className={" borderRadiusAllVoucherNew"} bg={"white"}>
        <Box bg="white" className="borderRadiusAll" m={"xs"}>
          <Box
            ...
            pt={"xs"}
            bg={"white"}>
            <BookingInventorySearch module={"customer"} />
          </Box>
        </Box>
...
export default BookingInventoryTableInProgress;
