...
import SurgeryViewModel from "./SurgeryViewModel.jsx";
...
function SurgeryTable() {
  ...
  const [surgeryViewModel, setSurgeryViewModel] = useState(false);
  ...
  const data = [
    {
      code: "2011",
      Surgery_department: "General Surgery",
  ...
  return (
    <>
      ...
      {surgeryViewModel && (
        <SurgeryViewModel
          surgeryViewModel={surgeryViewModel}
          setSurgeryViewModel={setSurgeryViewModel}
        />
      )}
    </>
  );
