...
import ServiceGroupViewModel from "./ServiceGroupViewModel.jsx";
...
function ServiceGroupTable() {
  ...
  const [serviceGroupViewModel, setServiceGroupViewModel] = useState(false);
  ...
  return (
    <>
      ...
      {serviceGroupViewModel && (
        <ServiceGroupViewModel
          serviceGroupViewModel={serviceGroupViewModel}
          setServiceGroupViewModel={setServiceGroupViewModel}
        />
      )}
    </>
  );
