...
import ServiceGroupGroupModal from "./ServiceGroupGroupModal.jsx";
                    ...
                    <Box>
                      ...
                      <Box mt={"xs"} mb={"xs"}>
                        <NativeSelect
                          tooltip={t("Details")}
                          label={t("PersonName")}
                          defaultValue="---Select service group---"
                          required={false}
                      ...
                      <Box mt={"xs"}>
                        <InputForm
                          ...
                          label={t("ServiceGroupName")}
                          placeholder={t("ServiceGroupNamePlaceholder")}
                          required={true}
                          nextField={"price"}
                          name={"name"}
                          form={form}
