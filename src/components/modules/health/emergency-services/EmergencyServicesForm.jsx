...
import EmergencyServicesGroupModal from "./EmergencyServicesGroupModal.jsx";

function EmergencyServicesForm() {
                    ...
                    <Box>
                      ...
                      <Box mt={"xs"}>
                        <InputForm
                          ...
                          label={t("EmergencyServicesName")}
                          placeholder={t("EmergencyServicesNamePlaceholder")}
                          required={true}
                          nextField={"price"}
                          name={"name"}
                          form={form}
