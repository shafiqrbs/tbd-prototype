...
import EmergencyServicesViewModel from "./EmergencyServicesViewModel.jsx";

function EmergencyServicesTable() {
  ...
  const [emergencyServicesViewModel, setEmergencyServicesViewModel] =
    useState(false);
    ...
    <>
      ...
      {emergencyServicesViewModel && (
        <EmergencyServicesViewModel
          ...
          setEmergencyServicesViewModel={setEmergencyServicesViewModel}
        />
      )}
    </>
  );
