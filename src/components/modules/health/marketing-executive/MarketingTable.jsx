...
import MarketingViewModel from "./MarketingViewModel.jsx";
...
function MarketingTable() {
  ...
  const [marketingViewModel, setMarketingViewModel] = useState(false);
    ...
    <>
      ...
      {marketingViewModel && (
        <MarketingViewModel
          ...
          setMarketingViewModel={setMarketingViewModel}
        />
      )}
    </>
  );
