...
import PathologyTestViewModel from "./PathologyTestViewModel.jsx";
...
function PathologyTestTable() {
  ...
  const [pathologyTestViewModel, setPathologyTestViewModel] = useState(false);
  ...
  return (
    <>
      ...
      {pathologyTestViewModel && (
        <PathologyTestViewModel
          pathologyTestViewModel={pathologyTestViewModel}
          setPathologyTestViewModel={setPathologyTestViewModel}
        />
      )}
    </>
  );
