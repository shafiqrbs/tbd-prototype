...
import CabinGroupModal from "./CabinGroupModal.jsx";
                    ...
                    <Box>
                      ...
                      <Box mt={"xs"}>
                        <Select
                          ...
                          placeholder={t("Cabin")}
                          required={true}
                          nextField={"account_choose"}
                          name={"cabin_ward"}
                          form={form}
                          mt={0}
                          id={"cabin_ward"}
                          defaultValue="----Select cabin/ward----"
                          data={[
                            "----Select cabin/ward----",
                            "cabin",
                            "Cabin fees",
                      ...
                      <Box mt={"xs"}>
                        <InputForm
                          tooltip={t("NameValidateMessage")}
                          label={t("PerDayPrice")}
                          placeholder={t("PerDayPricePlaceholder")}
                          required={true}
                          nextField={"details"}
                          name={"per_day_price"}
                          form={form}
