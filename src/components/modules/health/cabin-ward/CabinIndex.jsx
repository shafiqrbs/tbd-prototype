...
import CabinForm from "./CabinForm.jsx";
import CabinTable from "./CabinTable.jsx";
import CabinUpdateForm from "./CabinUpdateForm.jsx";
        ...
        <>
          ...
          <Box p={"8"}>
            <Grid columns={24} gutter={{ base: 8 }}>
              ...
              <Grid.Col span={9}>
                {insertType === "create" ? <CabinForm /> : <CabinUpdateForm />}
              </Grid.Col>
            </Grid>
          </Box>
        </>
