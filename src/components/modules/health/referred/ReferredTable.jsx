...
import ReferredViewModel from "./ReferredViewModel.jsx";
...
function ReferredTable() {
  ...
  const [referredViewModel, setReferredViewModel] = useState(false);
  ...
  const data = [
    {
      ...
      mobile: "01700000098",
      commission: "0%",
      location: "Lakshmipur sadar, Lakshmipur",
    },
    {
      code: "02",
      person_name: "Foysal Mahmud",
    ...
    <>
      ...
      {referredViewModel && (
        <ReferredViewModel
          ...
          setReferredViewModel={setReferredViewModel}
        />
      )}
    </>
  );
