...
import ServicesViewModel from "./ServicesViewModel.jsx";
...
function ServicesTable() {
  ...
  const [servicesViewModel, setServicesViewModel] = useState(false);
    ...
    <>
      ...
      <Box className={"borderRadiusAll border-top-none"}>
        <DataTable
          ...
          columns={[
            ...
            { accessor: "admission_default", title: t("AdmissionDefault") },
      ...
      {servicesViewModel && (
        <ServicesViewModel
          ...
          setServicesViewModel={setServicesViewModel}
        />
      )}
    </>
  );
